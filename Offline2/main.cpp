        ...
        while (in>>line) {
            if(line=="triangle"){
                ...
                for(int i=0;i<3;i++){
                    ...
                    cout<<point[0][0]<<" "<<point[1][0]<<" "<<point[2][0]<<endl ;
            ...
            if(line=="translate"){
                ...
                double** newTransformationMatrix = view.crossMatrix(translateMatrix,view.transformationStack.top(),4,4);
            ...
            if(line=="scale"){
                ...
                double** newTransformationMatrix = view.crossMatrix(scaleMatrix,view.transformationStack.top(),4,4);
                view.transformationStack.pop();
                view.transformationStack.push(newTransformationMatrix);
            }
            ...
            if(line=="rotate"){
                ...
                double** newTransformationMatrix = view.crossMatrix(rotationMatrix,view.transformationStack.top(),4,4);
                view.transformationStack.pop();
                view.transformationStack.push(newTransformationMatrix);
